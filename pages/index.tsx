            ...
            <div className="grid grid-cols-[repeat(auto-fit,minmax(14rem,1fr))] gap-8 justify-items-center">
              {todos.map((todo) => (
                <div
                  key={todo.id}
                  className={[
                    "flex flex-col w-full max-w-56 h-80 rounded-xl shadow-2xl p-4 relative hover:scale-105",
                    `bg-${todo.bgColor}-500`,
                  ].join(" ")}
                >
                  <div className="flex justify-between items-center ">
              ...
              <div className="flex justify-center items-center w-full max-w-56 h-80 rounded-xl border border-dashed text-white hover:scale-105">
                <div>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    fill="none"
