...
interface ListProp {
  name: string;
  setIsEditListPopup: Dispatch<SetStateAction<boolean>>;
  setIsMemberListPopup: Dispatch<SetStateAction<boolean>>;
  setIsDeleteListPopup: Dispatch<SetStateAction<boolean>>;
}

export default function List({
  name,
  setIsEditListPopup,
  setIsMemberListPopup,
  setIsDeleteListPopup,
}: ListProp) {
  return (
